		...
		<div class={removeNonStringsAndTrim(baseClasses.root, isValid.value === false && 'border-red-500 focus-within:border-red-500')}>
			<div class='grid grid-cols-[1fr,auto] items-center h-16'>
				<div class='grid px-4'>
					...
					<input ref={inputRef} placeholder={props.placeholder} pattern='^0x[0-9A-Fa-f]{40}$' class={baseClasses.field} type='text' value={props.value} onInput={handleInput} required />
				</div>
				{props.value !== '' && (
