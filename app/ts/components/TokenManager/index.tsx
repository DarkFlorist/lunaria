		...
		<div class='aspect-square bg-neutral-800 p-4 flex items-end relative group outline-none' tabIndex={1}>
			...
			<div class='absolute inset-0 hidden group-hover:block group-focus:block'>
				{removal.value ? (
					...
					<>
						<button class='absolute inset-0 w-full flex items-center justify-center bg-black/80 border border-white/50' onClick={() => onSelect(token)}>Tap to use</button>
...
const NativeCard = ({ onSelect }: { onSelect: () => void }) => {
	return <div class='aspect-square bg-neutral-800 p-4 flex items-end relative group outline-none' tabIndex={1}>
		<div class='relative'>
		...
		<div class='absolute inset-0 hidden group-hover:block group-focus:block'>
			<>
				<button class='absolute inset-0 w-full flex items-center justify-center bg-black/80 border border-white/50' onClick={onSelect}>Tap to use</button>
			</>
		</div>
	</div>
}
