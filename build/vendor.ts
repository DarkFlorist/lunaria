...
const dependencyPaths = [
	{
		...
		subfolderToVendor: 'dist',
		entrypointFile: 'es-module-shims.js',
	},
	{
		packageName: 'preact',
		subfolderToVendor: 'dist',
		entrypointFile: 'preact.module.js',
	},
	{
		packageName: 'preact/jsx-runtime',
		subfolderToVendor: 'dist',
		entrypointFile: 'jsxRuntime.module.js',
	},
	{
		packageName: 'preact/hooks',
		subfolderToVendor: 'dist',
		entrypointFile: 'hooks.module.js',
	},
	{
		packageName: 'preact/compat',
		subfolderToVendor: 'dist',
		entrypointFile: 'compat.module.js',
	},
	{
		packageName: 'ethers',
		subfolderToVendor: 'dist',
		entrypointFile: 'ethers.esm.js',
	},
	{
		packageName: '@preact/signals-core',
		subfolderToVendor: 'dist',
		entrypointFile: 'signals-core.module.js',
	},
	{
		packageName: '@preact/signals',
		subfolderToVendor: 'dist',
		entrypointFile: 'signals.module.js',
	},
];
...
async function vendorDependencies() {
	for (const { packageName, subfolderToVendor } of dependencyPaths) {
		...
		await recursiveDirectoryCopy(
			...
			undefined,
			rewriteSourceMapSourcePath.bind(undefined, packageName)
		);
	}
	...
	const importmap = dependencyPaths.reduce(
		(importmap, { packageName, entrypointFile }) => {
			importmap.imports[packageName] = `./${path
				.join('.', 'vendor', packageName, entrypointFile)
				.replace(/\\/g, '/')}`;
			return importmap;
		},
		{ imports: {} as Record<string, string> }
	);
	const importmapJson = JSON.stringify(importmap, undefined, '\t').replace(
		/^/gm,
		'\t\t'
	);
	const newIndexHtml = oldIndexHtml.replace(
		/<script type='importmap'>[\s\S]*?<\/script>/m,
