...
function generateIdenticon(options) {
...
export default function SVGBlockie({ address }) {
    ...
    return (_jsx("svg", { width: '1em', height: '1em', viewBox: '0 0 64 64', xmlns: 'http://www.w3.org/2000/svg', children: imageData.map((data, index) => {
            const fill = data === 0 ? bgcolor : data === 1 ? color : spotcolor;
            const pixelSize = 64 / pixelDensity;
            return _jsx("rect", { width: pixelSize, height: pixelSize, x: ((index % pixelDensity) * 64) / pixelDensity, y: Math.floor(index / pixelDensity) * pixelSize, fill: fill });
        }) }));
}
//# sourceMappingURL=SVGBlockie.js.map