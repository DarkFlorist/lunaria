...
const HistoryList = ({ transfers }) => {
    ...
    return (_jsx("div", { children: transfers.map(transfer => {
            ...
            return (_jsxs("a", { class: 'block bg-white/10 px-4 py-3 mb-1 hover:bg-white/20', href: `#tx/${transfer.hash}`, children: [_jsxs("div", { class: 'overflow-hidden text-ellipsis whitespace-nowrap', children: ["Sent ", amount, " ", transfer.token?.name || 'ETH', " to ", transfer.to] }), _jsx("div", { class: 'text-sm text-white/50', children: _jsx(TimeAgo, { since: timeStamp }) })] }));
        }) }));
};
