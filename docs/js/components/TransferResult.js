...
const ErrorDetails = ({ message, summary }) => {
    ...
    return (_jsxs("div", { class: 'border border-red-400/50 bg-red-400/10 px-4 py-3 grid grid-cols-[min-content,1fr] gap-x-3 items-center', children: [_jsx("div", { children: _jsx(ExclamationIcon, {}) }), _jsxs("div", { children: [_jsx("div", { class: 'font-semibold', children: "Transaction failed!" }), _jsxs("p", { children: [_jsxs("span", { class: 'text-sm text-white/50', children: [summary, "."] }), "\u00A0", _jsxs("button", { type: 'button', class: 'appearance-none outline-none underline text-sm text-white/75 underline-offset-2 focus|hover:text-white', onClick: toggleMessageDisplay, children: [displayMessage.value ? 'Hide' : 'Show', " details"] })] })] }), _jsx("div", { class: 'col-span-2', children: displayMessage.value ? (_jsxs("div", { class: 'border border-white/10 bg-white/5 px-3 py-2 mt-2 group relative', children: [_jsx("pre", { class: 'whitespace-pre-wrap text-sm text-white/30 mb-2', children: message }), _jsx("div", { class: 'absolute right-2 bottom-2 hidden group-hover:block', children: _jsx(CopyButton, { value: message, withLabel: true }) })] })) : _jsx(_Fragment, {}) })] }));
};
